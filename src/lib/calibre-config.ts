...
const MANDARINE_CALIBRES: CalibreEntry[] = [
  { key: "1xxx", label: "1xxx", range: "≥74", dbColumn: "cal1xxx" },
  { key: "1xx", label: "1xx", range: "72-74", dbColumn: "cal1xx" },
  { key: "1x_sup", label: "1x", range: "68-72", dbColumn: "cal1xSup" },
  { key: "1x_inf", label: "1", range: "64-68", dbColumn: "cal1xInf" },
  { key: "2", label: "2", range: "59-64", dbColumn: "cal2" },
  { key: "3", label: "3", range: "55-59", dbColumn: "cal3" },
  { key: "4", label: "4", range: "51-55", dbColumn: "cal4" },
  { key: "5", label: "5", range: "47-51", dbColumn: "cal5" },
  { key: "6", label: "6", range: "44-47", dbColumn: "cal6" },
  { key: "hors_calibre", label: "Hors cal.", range: "<44", dbColumn: "calHorsCalibre" },
];

const NAVEL_CALIBRES: CalibreEntry[] = [
  { key: "0", label: "0", range: "≥93", dbColumn: "cal0" },
  { key: "1", label: "1", range: "88-93", dbColumn: "cal1" },
  { key: "2", label: "2", range: "85-88", dbColumn: "cal2" },
  { key: "3", label: "3", range: "82-85", dbColumn: "cal3" },
  { key: "4", label: "4", range: "78-82", dbColumn: "cal4" },
  { key: "5", label: "5", range: "74-78", dbColumn: "cal5" },
  { key: "6", label: "6", range: "71-74", dbColumn: "cal6" },
  { key: "7", label: "7", range: "68-71", dbColumn: "cal7" },
  { key: "8", label: "8", range: "65-68", dbColumn: "cal8" },
  { key: "10", label: "10", range: "61-65", dbColumn: "cal10" },
  { key: "11", label: "11", range: "59-61", dbColumn: "cal11" },
  { key: "hors_calibre", label: "Hors cal.", range: "<59", dbColumn: "calHorsCalibre" },
];
...
export const EXCEL_CALIBRE_COLUMNS: ExcelCalibreColumn[] = [
  ...
  { excelKey: "Cal_1xxx_M", excelHeader: "Cal_1xxx_M (≥74)",   dbColumn: "cal1xxx",    norm: "M" },
  { excelKey: "Cal_1xx_M",  excelHeader: "Cal_1xx_M (72-74)",  dbColumn: "cal1xx",     norm: "M" },
  { excelKey: "Cal_1x_M",   excelHeader: "Cal_1x_M (68-72)",   dbColumn: "cal1xSup",  norm: "M" },
  { excelKey: "Cal_1_M",    excelHeader: "Cal_1_M (64-68)",     dbColumn: "cal1xInf",  norm: "M" },
  { excelKey: "Cal_2_M",    excelHeader: "Cal_2_M (59-64)",     dbColumn: "cal2",       norm: "M" },
  { excelKey: "Cal_3_M",    excelHeader: "Cal_3_M (55-59)",     dbColumn: "cal3",       norm: "M" },
  { excelKey: "Cal_4_M",    excelHeader: "Cal_4_M (51-55)",     dbColumn: "cal4",       norm: "M" },
  { excelKey: "Cal_5_M",    excelHeader: "Cal_5_M (47-51)",     dbColumn: "cal5",       norm: "M" },
  { excelKey: "Cal_6_M",    excelHeader: "Cal_6_M (44-47)",     dbColumn: "cal6",       norm: "M" },
  // Navel columns (_N)
  { excelKey: "Cal_0_N",    excelHeader: "Cal_0_N (≥93)",       dbColumn: "cal0",       norm: "N" },
  { excelKey: "Cal_1_N",    excelHeader: "Cal_1_N (88-93)",     dbColumn: "cal1",       norm: "N" },
  { excelKey: "Cal_2_N",    excelHeader: "Cal_2_N (85-88)",     dbColumn: "cal2",       norm: "N" },
  { excelKey: "Cal_3_N",    excelHeader: "Cal_3_N (82-85)",     dbColumn: "cal3",       norm: "N" },
  { excelKey: "Cal_4_N",    excelHeader: "Cal_4_N (78-82)",     dbColumn: "cal4",       norm: "N" },
  { excelKey: "Cal_5_N",    excelHeader: "Cal_5_N (74-78)",     dbColumn: "cal5",       norm: "N" },
  { excelKey: "Cal_6_N",    excelHeader: "Cal_6_N (71-74)",     dbColumn: "cal6",       norm: "N" },
  { excelKey: "Cal_7_N",    excelHeader: "Cal_7_N (68-71)",     dbColumn: "cal7",       norm: "N" },
  { excelKey: "Cal_8_N",    excelHeader: "Cal_8_N (65-68)",     dbColumn: "cal8",       norm: "N" },
  { excelKey: "Cal_10_N",   excelHeader: "Cal_10_N (61-65)",    dbColumn: "cal10",      norm: "N" },
  { excelKey: "Cal_11_N",   excelHeader: "Cal_11_N (59-61)",    dbColumn: "cal11",      norm: "N" },
  // Hors calibre (shared)
  { excelKey: "Cal_HC",     excelHeader: "Cal_HC (<44M/<59N)",  dbColumn: "calHorsCalibre", norm: "HC" },
];
